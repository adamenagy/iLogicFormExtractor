...
{
    [Guid("67bf4343-a315-4bae-855e-f5fde7d653b4")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": iLogicFormExtractorPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": iLogicFormExtractorPlugin: deactivating... ");
